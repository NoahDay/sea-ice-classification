...
%ncdisp("/Users/noahday/GitHub/sea-ice-classification/mizWidth_2011.nc")
eff = ncread("/Users/noahday/GitHub/sea-ice-classification/mizWidth_2011.nc","effective");
...
%31+28+31 = 90
% April 1st to end of September
plot_data = eff(:,90:273)/1000;
close all
% conFigure(11)
% figure
% hist(plot_data(:),31)
...
m = mean(plot_data)
nexttile
histfit(plot_data,101,'lognormal')
nexttile
y_weibull = histfit(plot_data,101,'weibull');
nexttile
y_rayleigh = histfit(plot_data,101,'rayleigh');


fitdist(plot_data,'lognormal')
fitdist(plot_data,'weibull')
fitdist(plot_data,'rayleigh')

%%


plot_data = eff(:,[1:89 273:end])/1000;
